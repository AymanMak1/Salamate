!(function (e, t) {
      ...
      return (
        ...
        (function (e, n, o) {
          ...
          return (
            ...
            p(o) &&
              ((v = !!o.leading),
              (r = (g = "maxWait" in o) ? l(b(o.maxWait) || 0, n) : r),
  ...
  var L = function (e, t, n) {
      ...
      return (
        ...
        A(n) &&
          ((d = !!n.leading),
          (a = (l = "maxWait" in n) ? E(q(n.maxWait) || 0, t) : a),
  ...
  var B = new ((function () {
        ...
        D(e, [
          {
            ...
            value: function () {
              var e = _();
              return !(!$.test(e) && !W.test(e.substr(0, 4)));
            },
          },
          {
            key: "mobile",
            ...
            a =
              ...
              function () {
                e.animated &&
                  ...
                  F("aos:out", i),
                  e.options.id && F("aos:in:" + e.options.id, i),
                  (e.animated = !1));
              });
    ...
    J = function (e, t) {
      return (
        e.forEach(function (e, n) {
          var o = G(e.node, "mirror", t.mirror),
            ...
            (e.position = {
              in: (function (e, t, n) {
                var o = window.innerHeight,
                  i = G(e, "anchor"),
                  a = G(e, "anchor-placement"),
                  r = Number(G(e, "offset", a ? 0 : t)),
                  c = a || n,
                  s = e;
                i &&
    ...
    ee = function () {
      if (((R = Q()), ne(V.disable) || X())) return te();
      Z();
    },
    te = function () {
      R.forEach(function (e, t) {
        e.node.removeAttribute("data-aos"),
          ...
          V.initClassName && e.node.classList.remove(V.initClassName),
          V.animatedClassName && e.node.classList.remove(V.animatedClassName);
      });
    },
    ne = function (e) {
      return (
      ...
      return (
        ...
        ne(V.disable) || X()
          ...
          : (document
            ...
            -1 === ["DOMContentLoaded", "load"].indexOf(V.startEvent)
            ...
            "DOMContentLoaded" === V.startEvent &&
              ...
              Z(!0),
            window.addEventListener("resize", L(Z, V.debounceDelay, !0)),
            window.addEventListener(
              "orientationchange",
              L(Z, V.debounceDelay, !0)
            ),
            R)
      );
    },
